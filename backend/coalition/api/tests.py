...
class HomepageAPITest(TestCase):
    def setUp(self) -> None:
        ...
        self.homepage = HomePage.objects.create(
            ...
            about_section_content="We are dedicated to thorough testing of our platform.",
    ...
    def test_get_homepage_success(self) -> None:
        ...
        assert data["about_section_content"] == "We are dedicated to thorough testing of our platform."
    ...
    def test_homepage_api_response_structure(self) -> None:
        ...
        required_fields = [
            "id", "organization_name", "tagline", "hero_title", "hero_subtitle",
            "hero_background_image", "about_section_title", "about_section_content",
            "cta_title", "cta_content", "cta_button_text", "cta_button_url",
            "contact_email", "contact_phone", "facebook_url", "twitter_url",
            "instagram_url", "linkedin_url", "campaigns_section_title",
            "campaigns_section_subtitle", "show_campaigns_section",
            "content_blocks", "is_active", "created_at", "updated_at"
        ]
        ...
        if data["content_blocks"]:
            ...
            content_block_fields = [
                "id", "title", "block_type", "content", "image_url",
                "image_alt_text", "css_classes", "background_color",
