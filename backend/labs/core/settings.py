...
INSTALLED_APPS = [
    ...
    "labs.campaigns.apps.CampaignsConfig",
    "labs.endorsers.apps.EndorsersConfig",
    "labs.legislators.apps.LegislatorsConfig",
    "labs.regions.apps.RegionsConfig",
    "labs.core",
]
...
WSGI_APPLICATION = "labs.core.wsgi.application"
